...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ComponentsComp2 = __webpack_require__(198);

	var _ComponentsComp22 = _interopRequireDefault(_ComponentsComp2);

	var routes = _react2['default'].createElement(_reactRouter.Route, { handler: _ComponentsComp22['default'], path: '/' });

	// Router.run(routes, function (Handler) {
	//   React.render(<Handler/>, document.body);
	// });

	var router = _reactRouter.ReactRouter.create({
		location: _reactRouter.ReactRouter.HashLocation,
		routes: routes
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Comp2 = (function (_React$Component) {
	  ...
	  function Comp2(props) {
	    ...
	    _get(Object.getPrototypeOf(Comp2.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(Comp2, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement('input', { type: 'text', placeholder: 'enter', onChange: this.handle }),
